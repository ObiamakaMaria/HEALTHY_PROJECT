...
- Before Running the run.py file which is the main entry point for the application you must have set the followin environment variables: DB_USER=any DB_PASSWORD=any DB_HOST=localhost DB_NAME=HEALTHY DB_YTB_API=Your Youtube api key
